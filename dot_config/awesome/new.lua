...
-- Things to run once at startup
-- run_once({ "urxvtd", "unclutter -root" }) -- comma-separated entries
run_once({ "launch_polybar", "dunst &", "picom -b &" })
...
-- Add support for hiden 10th workspace
globalkeys = mytable.join(globalkeys,
    -- View tag only.
    awful.key({ modkey }, "0",
              function ()
              ...
              {description = "view tag 0 (10th)", group = "tag"})
)
